...
object BankDetailsErrorPage extends BasePage {
  ...
  private val contactHmrcLocator: By              = By.xpath("//p[contains(@class, 'govuk-body')][contains(., 'call us')]")
  ...
  def verifyAllErrorMessages(): Unit = {
    ...
    contactHmrcText              shouldBe "If this issue persists you may have to call us on 0300 322 9665."
  }
}
