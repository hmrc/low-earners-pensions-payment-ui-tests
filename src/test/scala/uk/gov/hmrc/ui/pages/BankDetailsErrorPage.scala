...
object BankDetailsErrorPage extends BasePage {
  ...
  private val errorHeadingLocator: By = By.xpath("//p[contains(@class, 'govuk-body')][contains(., 'An error occurred')]")
  private val tryAgainButtonLocator: By = By.partialLinkText("Try again")
  private val rollNumberErrorLocator: By = By.xpath("//ul[contains(@class, 'govuk-list')]/li[contains(., 'roll number')]")
  private val directCreditErrorLocator: By = By.xpath ("//ul[contains(@class, 'govuk-list')]/li[contains(., 'direct credit')]")
  private val accountNotFoundErrorLocator: By = By.xpath ("//ul[contains(@class, 'govuk-list')]/li[contains(., 'no account')]")
  private val accountNameMismatchErrorLocator: By = By.xpath ("//ul[contains(@class, 'govuk-list')]/li[contains(., 'name on the account')]")
  ...
  override def checkJourneyUrl(url: String = "bank-details-check-errors"): Unit =
